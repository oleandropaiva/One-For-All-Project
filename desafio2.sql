...
COUNT(DISTINCT albunss.album_id) AS albuns
	...
	INNER JOIN 
        SpotifyClone.album_table AS albunss ON albunss.album_id = cancoess.album_id
	INNER JOIN 
        SpotifyClone.artistas_table AS artistass ON artistass.artista_id = albunss.artista_id;
